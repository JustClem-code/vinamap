...
ALTER SEQUENCE public.product_id_seq OWNER TO "user";
...
DoctrineMigrations\\Version20240723185429	2024-07-24 10:47:40	89
\.
...
99	Carménère
100	Bouchet
101	Mondeuse blanche
102	Terret Blanc
103	Muscat blanc à petits grains
104	Aspiran
105	Pinot Meunier
106	Müller-thurgau
107	Téoulier noir
...
COPY public.product (id, appellation_id, user_email_id, name, manufacturer, vintage, review) FROM stdin;
1	159	14	Daronnade	test manufacturer	2023	\N
2	126	14	Greeves	test manufacturer	2022	\N
3	126	14	Dernières	Tiraquette	2022	\N
4	84	14	La grosse daronne	Jeff	2030	C'est pas très bon
\.
...
SELECT pg_catalog.setval('public.grape_variety_id_seq', 120, true);
...
--
-- Name: idx_d34a04ad48bf25c9; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_d34a04ad48bf25c9 ON public.product USING btree (user_email_id);


--
-- Name: idx_d34a04ad7cde30dd; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX idx_d34a04ad7cde30dd ON public.product USING btree (appellation_id);
...
--
-- Name: product fk_d34a04ad48bf25c9; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.product
    ADD CONSTRAINT fk_d34a04ad48bf25c9 FOREIGN KEY (user_email_id) REFERENCES public."user"(id);


--
-- Name: product fk_d34a04ad7cde30dd; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.product
    ADD CONSTRAINT fk_d34a04ad7cde30dd FOREIGN KEY (appellation_id) REFERENCES public.appellation(id);
